...
function init_charts() {
  if (
    ...
    if ($("#lineChart").length) {
	  var config = {
		apiKey: "AIzaSyAFV4s38zw1ymWkmxeY_SgBXMqJ2c6nleM",
		authDomain: "lap-counter.firebaseapp.com",
		databaseURL: "https://lap-counter.firebaseio.com",
		projectId: "lap-counter",
		storageBucket: "lap-counter.appspot.com",
	  	messagingSenderId: "69174368354"
	  };
